...
public class HospitalBlood1F extends AppCompatActivity {
    ...
    private void setUpRecyclerView() {
        ...
        Query query = childRef.whereEqualTo("hospitalName", "Soliman Fakeeh Hospital").whereEqualTo("typeOfPlan", "Plus");
        ...
        adapter.setOnItemClickListener(new HospitalAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent i = new Intent(HospitalBlood1F.this, BloodResults1F.class);
                i.putExtra("id", id);
                startActivity(i);
