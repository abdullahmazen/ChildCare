...
public class HospitalAppointments extends AppCompatActivity {
    ...
    private void setUpRecyclerView() {
        ...
        Query query = childRef.whereEqualTo("hospitalName", "King Abdullah Hospital").whereEqualTo("dateStatus", "yes");
        ...
        adapter.setOnItemClickListener(new HospitalAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent i = new Intent(HospitalAppointments.this, AppointmentDetails.class);
                i.putExtra("id", id);
                startActivity(i);
