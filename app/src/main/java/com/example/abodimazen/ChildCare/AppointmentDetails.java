    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                            ...
                            db.collection("Child").document(n).update(updates).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(AppointmentDetails.this, "Done! ", Toast.LENGTH_SHORT).show();

                                    } else {

                                        Toast.makeText(AppointmentDetails.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                ...
                Intent i = new Intent(AppointmentDetails.this, Pro_hospital.class);
